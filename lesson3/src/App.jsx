    ...
    <div>
      <h1>Simple Single Page Application</h1>
        <ul className="header">
          ...
          >Home</NavLink></li>
          <li><NavLink to="/stuff"className={({ isActive }) => isActive ? "active" : undefined}
          >Stuff</NavLink></li>
          <li><NavLink to="/class" className={({ isActive }) => isActive ? "active" : undefined}
          >Class</NavLink></li>
          <li><NavLink to="/contact" className={({ isActive }) => isActive ? "active" : undefined}
          >Contact</NavLink></li>
          <li><NavLink to="/todo" className={({ isActive }) => isActive ? "active" : undefined}
          >ToDo</NavLink></li>
        </ul>
    </div>
  );
